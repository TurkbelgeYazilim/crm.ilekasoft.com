						...
						<div class="row">
							<div class="col-sm-10">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Banka Virman</li>
								</ul>
							</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<form action="<?= base_url("banka/yeniVirmanIslemi"); ?>" method="POST">
										<!-- <input type="hidden" name="banka_id" id="banka_id">
										<input type="hidden" name="banka_id2" id="banka_id2"> -->

										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label>Belge No</label>
													<input type="text" class="form-control" name="virman_belgeNo" required="">
												</div>
											</div>
											<?php
											...
											<!--<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="virman_kaynakBankaAdi" required="" id="ad_input">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Kaynak Hesap No</label>
													<input type="text" class="form-control" name="virman_kaynakHesapNo" required="" id="no_input">
												</div>
											</div> -->
										</div>
										...
										<div class="row">
											...
											<!--<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="virman_hedefBankaAdi" required="" id="ad_input2">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Hedef Hesap No</label>
													<input type="text" class="form-control" name="virman_hedefHesapNo" required="" id="no_input2">
												</div>
											</div> -->
										</div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label>Tarih</label>
													<input type="text" class="datepicker form-control" name="virman_tarih" required="" autocomplete="off" value="<?= getirBugun(); ?>">
												</div>
											</div>
											<div class="col-md-8">
												<div class="form-group">
													<label>Tutar</label>
													<input type="number" step="0.01" class="form-control" name="virman_tutar" required="">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label>Açıklama</label>
													<textarea class="form-control" name="virman_aciklama"></textarea>
												</div>
											</div>
										</div>
