						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<form action="<?= base_url("banka/yeniBankaIslemi"); ?>" method="POST">
										<input type="hidden" name="banka_id" id="banka_id">
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label>Belge No</label>
													<input type="text" class="form-control" name="islem_belgeNo" required="">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Banka Adı</label>
													<input type="text" class="form-control" name="islem_bankaAdi" required="" id="ad_input">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Hesap No</label>
													<input type="text" class="form-control" name="islem_hesapNo" required="" id="no_input">
												</div>
											</div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label>Tarih</label>
													<input type="text" class="datepicker form-control" name="islem_tarih" required="" autocomplete="off" value="<?= getirBugun(); ?>">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Tutar</label>
													<input type="number" step="0.01" class="form-control" name="islem_tutar" required="">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													...
													<select name="islem_islemTipi" class="select form-control" required="">
														...
														<option value="1">Giriş İşlemi</option>
														<option value="2">Çıkış İşlemi</option>
													</select>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													...
													<textarea class="form-control" name="islem_aciklama"></textarea>
												</div>
											</div>
										</div>
