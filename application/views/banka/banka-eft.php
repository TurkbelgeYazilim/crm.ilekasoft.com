						...
						<div class="row">
							<div class="col-sm-10">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Banka EFT</li>
								</ul>
							</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<form action="<?= base_url("banka/yeniBankaEFT"); ?>" method="POST">
										<input type="hidden" name="cari_id" id="cari_id">
										<!-- <input type="hidden" name="banka_id" id="banka_id"> -->
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label>Belge / EFT No</label>
													<input type="text" class="form-control" name="eft_belgeNo" required="">
												</div>
											</div>
												...
												<div class="form-group">
													...
													<select class="form-control select" name="banka_id">
														...
														<?php foreach($banks as $ba){?>
															<option value="<?= $ba->banka_id; ?>"><?= $ba->banka_bankaAd; ?></option>
														<?php }?>
													</select>
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="eft_bankaAdi" required="" id="ad_input">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Hesap No</label>
													<input type="text" class="form-control" name="eft_hesapNo" required="" id="no_input">
												</div>
											</div> -->
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="eft_cariAdi" required="" id="cariadi_input">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Cari Kodu</label>
													<input type="text" class="form-control" name="eft_cariKodu" required="" id="carikodu_input">
												</div>
											</div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label>Tarih</label>
													<input type="text" class="datepicker form-control" name="eft_tarih" required="" autocomplete="off" value="<?= getirBugun(); ?>">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Tutar</label>
													<input type="number" step="0.01" class="form-control" name="eft_tutar" required="">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													...
													<select name="eft_islemTipi" class="select form-control" required="">
														...
														<option value="1">Gelen EFT</option>
														<option value="2">Giden EFT</option>
													</select>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													...
													<textarea class="form-control" name="eft_aciklama"></textarea>
												</div>
											</div>
										</div>
