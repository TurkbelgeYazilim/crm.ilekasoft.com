						...
						<div class="row">
							<div class="col-sm-10">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Banka Havale / EFT</li>
								</ul>
							</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<form action="<?= base_url("banka/yeniBankaHavale"); ?>" method="POST">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="havale_belgeNo" required="">
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="havale_bankaAdi" required="" id="ad_input">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Hesap No</label>
													<input type="text" class="form-control" name="havale_hesapNo" required="" id="no_input">
												</div>
											</div>-->
											<div class="col-md-6">
												<div class="form-group">
													<label>Cari Adı</label>
													<input type="text" class="form-control" name="havale_cariAdi" required="" id="cariadi_input">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Cari Kodu</label>
													<input type="text" class="form-control" name="havale_cariKodu" required="" id="carikodu_input">
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label>Tarih</label>
													<input type="text" class="datepicker form-control" name="havale_tarih" required="" autocomplete="off" value="<?= getirBugun(); ?>">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Tutar</label>
													<input type="number" step="0.01" class="form-control" name="havale_tutar" required="">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													...
													<select name="havale_islemTipi" class="select form-control" required="">
														...
														<option value="1">Gelen Havale / EFT</option>
														<option value="2">Giden Havale / EFT</option>
													</select>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													...
													<textarea class="form-control" name="havale_aciklama"></textarea>
												</div>
											</div>
										</div>
