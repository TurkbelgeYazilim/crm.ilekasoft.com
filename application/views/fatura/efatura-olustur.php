				...
				<div class="row">
					<div class="col-sm-10">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item active">E-Fatura Fatura Oluştur</li>
						</ul>
					</div>
						...
						<div class="card-body">
							...
							<form action="<?= base_url("fatura/satisFaturasiGuncelle/"); ?>" method="POST" id="myForm">
								...
								<form action="<?= base_url("fatura/satisFaturasiOlustur"); ?>" method="POST"
									...
									?>
									<input type="hidden" name="satis_InvoiceType" value="1">
												...
												<div class="col-md-7">
													...
													<div class="col-md-12">
														<div class="form-group row">
															...
															<div class="col-sm-9">
																<select class="form-control" name="satis_faturaSenaryo"
																		id="satis_faturaSenaryo" required=""
																		onchange="javascript: if(this.value=='2')document.getElementById('satis_efaturaTip').value='1';">
																	<option value="1" <?php if ($faturaDetay->satis_faturaSenaryo == 1) echo "selected"; ?>>
																		TEMEL FATURA
																	</option>
																	<option value="2" <?php if ($faturaDetay->satis_faturaSenaryo == 2) echo "selected"; ?>>
																		TİCARİ FATURA
																	</option>
																</select>
															</div>
														...
														<div class="form-group row">
															...
															<div class="col-sm-9" id="satis_efaturaTip_div">
																<select class="form-control" name="satis_efaturaTip"
																		id="satis_efaturaTip" required=""
																		onchange="javascript: if(this.value=='2')document.getElementById('satis_faturaSenaryo').value='1';">
															...
															<tr>
																...
																<td>
																	<input type='text' class='form-control'
																		   ...
																		   readonly value="<?= $item->stok_kodu ?>" y>
																</td>
																<td>
																...
																<td>
																	<select class='form-control' name='birim[]' id='birim<?= $items ?>' >
											...
											<div class="row"
												...
												<div class="col-md-12">
													...
													<p style="font-style:italic;color:red;">
														...
														! İhracat kayıtlı faturalarda 701 , 702 veya 703 nolu
														kodlar kullanız . .
													</p>
													<table class="table custom-table mb-0">
														<tr>
				...
				<form action="<?= base_url("cari/yeniCariKartiOlustur"); ?>" method="POST" id="myForm">
					<div class="row">
						<div class="form-group col-md-12">
							<input type="hidden" name="page" value="efatura">
	...
	function hesapla() {
		...
		for (i = 1; i <= items; i++) {
			...
			if (!isNaN(satir)) {
				...
				console.log("fiyat round:" + round(fiyat.toFixed(3), 2));
			...
			console.log("tevkifattop:" + round(tevkifattop.toFixed(3), 2));
			console.log("geneltop:" + geneltop);
			geneltop = round(geneltop.toFixed(3), 2) - round(tevkifattop.toFixed(3), 2);
			console.log("sonuc geneltop:" + geneltop);
			...
			select: function (event, ui) {
				...
				if (aliaspk == "") {
					swal({
						title: "Bilgilendirme",
						type: "error",
						text: "Seçmiş olduğunuz cari e-fatura mükellefi değildir. E-fatura düzenlenemez. E-arşiv düzenleyebilizsiniz.",
						confirmButtonText: 'Tamam',
						button: false,
						timer: 5000,
					});
...
<script>
	...
	$("#satis_efaturaTip").on('change', function () {
		var val = $(this).val();
...
<?php if ($this->session->flashdata('fatura_stok_bos')): ?>
	<script>
		swal({
			title: "Bilgilendirme",
			type: "error",
			text: "Fatura stok bilgilerini tekrar düzenleyip deneyiniz.",
			confirmButtonText: 'Tamam',
			button: false,
			timer: 5000,
		});
