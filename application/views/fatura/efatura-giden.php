...
<div class="main-wrapper">
				...
				<div class="row">
					<div class="col-sm-10">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item active">e-Fatura Giden Kutusu</li>
						</ul>
					</div>
				...
				<div class="col-xl-12 col-md-12">
					<div class="card card-table">
						<div class="card-header">
							<div class="row">
								<div class="col">
									<h5 class="card-title">E-Fatura Giden Kutusu</h5>
								</div>
								<div class="col-auto">
										...
										<tr>
											...
											<td class="text-right">
												...
												<?php if ($modul) {
													...
													if($faturaDurum==1){?>
														<a href="<?= base_url("fatura/efatura-olustur/".$sf->satis_id); ?>" class="dropdown-item mr-2" style="color:green;"><i class="far fa-edit mr-1"></i> Düzenle</a>
														<a href="<?= base_url('fatura/goruntule?tipi=satis&id='.$sf->satis_id); ?>" class="dropdown-item mr-2" style="color:orange;" target="_blank"><i class="far fa-eye mr-1"></i> Önizleme</a>
														<a href="<?= base_url(""); ?>"
	...
	<div id="fatura_sil" class="modal custom-modal fade" role="dialog">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">E-Fatura Silme</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
	...
	<?php
	$seriFatura = $this->db->query("SELECT * FROM seriYonetimi WHERE seri_olusturanAnaHesap = '$anaHesap' AND seri_urun= 1")->result();
	?>
	...
	<div id="gonder" class="modal custom-modal fade" role="dialog">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="<?= base_url("Edonusum/Efatura/SendInvoice"); ?>" method="POST">
