				...
				<div class="row">
					<div class="col-sm-10">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item active">e-Fatura Gelen Kutusu</li>
						</ul>
					</div>
				...
				<div class="col-xl-12 col-md-12">
					<div class="card card-table">
						<div class="card-header">
							<div class="row">
								<div class="col">
									<h5 class="card-title">E-Fatura Gelen Kutusu</h5>
								</div>
								<div class="col-auto">
...
<script type="text/javascript">
	...
	function datatable_fill(donem=null,faturastart=null,faturaend=null,faturaNo=null,vkn=null)
	{
		...
		$('#datatable').DataTable( {
			...
			"ajax": {
				"url": "<?= env('BASE_URL'); ?>/Edonusum/Efatura/GetInvoice/"+donem+"/"+faturastart+"/"+faturaend+"/"+faturaNo+"/"+vkn,
				"type": "GET"
			},
