...
<head>
		...
		<title>ilekaSoft CRM - Fatura / Satış Faturası - Muhasebe Programı</title>
</head>
	<body>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Satış Faturası</li>
								</ul>
							</div>
						</div>
					</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<form action="<?= base_url("fatura/satisFaturasiOlustur"); ?>" method="POST">
										<input type="hidden" name="satis_cariID" id="cari_id">
										<div class="row">
											<div class="col-md-6">
											...
											<!--<div class="col-md-3">
												<div class="form-group">
													<label>Fatura</label>
													<select class="select form-control" name="satis_faturaTipi" required="" id="faturaTipi">
											...
											<div class="col-md-3">
												<div class="form-group">
													<label>Ödeme</label>
													<select class="select form-control" name="satis_odemeTipi" id="odemeTipi" disabled>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="satis_irsaliyeNo" required="">
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															<label>İrsaliye Tarihi</label>
															<input type="text" class="datepicker form-control" name="satis_irsaliyeTarihi" autocomplete="off" required="" value="<?= getirBugun(); ?>" />
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="datepicker form-control" name="satis_faturaTarihi" autocomplete="off" required="" value="<?= getirBugun(); ?>"/>
														</div>
													</div>
												</div>
										</div>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															...
															<textarea class="form-control" name="satis_aciklama"></textarea>
														</div>
													</div>
												</div>
										</div>
