...
<head>
		...
		<title>ilekaSoft CRM - Fatura / Alış Faturası - Muhasebe Programı</title>
</head>
	<body>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Alış Faturası</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<form action="<?= base_url("fatura/alisFaturasiOlustur"); ?>" method="POST">
										<input type="hidden" name="alis_cariID" id="cari_id">
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label>Cari Kodu</label>
													<input type="text" class="form-control" name="cari_kodu" id="kod_input" required="">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Cari Adı</label>
													<input type="text" class="form-control" name="cari_adi" id="name_input" required="">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Cari Grubu</label>
													<input type="text" class="form-control" name="" id="cari_grubu_input" readonly>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Vergi Dairesi</label>
													<input type="text" class="form-control" name="" id="cari_vergiDairesi_input" readonly>
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Vergi Numarası</label>
													<input type="text" class="form-control" name="" id="cari_vergiNumarasi_input" readonly>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
											...
											<!--<div class="col-md-3">
												<div class="form-group">
													<label>Fatura</label>
													<select class="select form-control" name="alis_faturaTipi" required="" id="faturaTipi">
														<option value="">Fatura tipi seçiniz...</option>
														<option value="1">Açık Fatura</option>
														<option value="2">Kapalı Fatura</option>
													</select>
												</div>
											</div>
											<div class="col-md-3">
												<div class="form-group">
													<label>Ödeme</label>
													<select class="select form-control" name="alis_odemeTipi" id="odemeTipi" disabled>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="alis_irsaliyeNo" required="">
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															<label>İrsaliye Tarihi</label>
															<input type="text" class="datepicker form-control" name="alis_irsaliyeTarihi" autocomplete="off" required="" value="<?= getirBugun(); ?>"/>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															<label>Fatura No</label>
															<input type="text" class="form-control" name="alis_faturaNo" required="">
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															<label>Fatura Tarihi</label>
															<input type="text" class="datepicker form-control" name="alis_faturaTarihi" autocomplete="off" required="" value="<?= getirBugun(); ?>" />
														</div>
													</div>
												</div>
										</div>
											...
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														...
														<select class="select form-control" name="banka_id" id="banka" disabled>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<select class="select form-control" name="kasa_id" id="kasa" disabled>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="kasa_id" id="kasa" disabled>
													</div>
												</div>
											</div>
										</div> -->
													...
													<table class="table table-striped custom-table mb-0">
												        ...
												        <tfoot>
												        	<tr>
												        		...
												        		<th></th>
												        		<th></th>
												        		<th>Ara Toplam: <span id="aratop"></span></th>
												        		<th></th>
												        		<th>KDV: <span id="kdvtop"></span></th>
												        		<th></th>
												        		<th>Genel Toplam: <span id="geneltop"></span></th>
												        		<th></th>
												        	</tr>
												        </tfoot>
												    </table>
												...
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															...
															<textarea class="form-control" name="alis_aciklama"></textarea>
														</div>
													</div>
												</div>
										</div>
		...
		<script>
				...
				$(function() {
				    $("#stokKodu").autocomplete({
				        source: 'https://crm.ilekasoft.com/fatura/autocompleteDataByStockCode2/<?=$idsi?>',
				        minLength: 2,
				        select: function( event, ui ) {
				            event.preventDefault();
				...
				$(function() {
				    $("#stokAdi").autocomplete({
				        source: 'https://crm.ilekasoft.com/fatura/autocompleteDataByStockName2/<?=$idsi?>',
				        minLength: 2,
				        select: function( event, ui ) {
				            event.preventDefault();
				...
				$("#faturaTipi").on('change',function(){
					var status = $(this).val();

						if(status == 2){
							$("#odemeTipi").prop('disabled', false);
						}

						if(status == 1){
							$("#odemeTipi").val('').change();
							$("#odemeTipi").prop('disabled', true);
