...
<head>
		...
		<title>ilekaSoft crm - Fatura / Alış Faturası Düzenle - Muhasebe Programı</title>
</head>
	<body>
											...
											<!--<div class="col-md-3">
												<div class="form-group">
													...
													<select class="select form-control" name="alis_faturaTipi" required="" id="faturaTipi">
														...
														<option value="1" <?php if($alisFaturasi->alis_faturaTipi == 1){echo "selected";} ?>>Açık Fatura</option>
														<option value="2" <?php if($alisFaturasi->alis_faturaTipi == 2){echo "selected";} ?>>Kapalı Fatura</option>
													</select>
												</div>
											</div>
											<div class="col-md-3">
												<div class="form-group">
													<label>Ödeme</label>
													<select class="select form-control" name="alis_odemeTipi" id="odemeTipi">
														<option value="">Ödeme tipi seçiniz...</option>
														<option value="1" <?php if($alisFaturasi->alis_odemeTipi == 1){echo "selected";} ?>>Kasa</option>
														<option value="2" <?php if($alisFaturasi->alis_odemeTipi == 2){echo "selected";} ?>>Banka</option>
													</select>
												</div>
											</div> -->
										</div>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="alis_irsaliyeNo" value="<?= $alisFaturasi->alis_irsaliyeNo; ?>" required="">
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															<label>İrsaliye Tarihi</label>
															<input type="text" class="datepicker form-control" name="alis_irsaliyeTarihi" autocomplete="off" value="<?= $yeni_irsaliyeTarihi; ?>" required=""/>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															<label>Fatura No</label>
															<input type="text" class="form-control" name="alis_faturaNo"  value="<?= $alisFaturasi->alis_faturaNo; ?>" required="">
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															<label>Fatura Tarihi</label>
															<input type="text" class="datepicker form-control" name="alis_faturaTarihi" autocomplete="off" value="<?= $yeni_faturaTarih; ?>" required=""/>
														</div>
													</div>
												</div>
										</div>
													...
													<div class="form-group">
														...
														<select class="select form-control" name="banka_id" id="banka">
															...
															<?php foreach($banka as $bnk){?>
																<option value="<?= $bnk->banka_id; ?>" <?php if($bnk->banka_id == $alisFaturasi->alis_bankaID){echo "selected";} ?>> <?= $bnk->banka_bankaAd." - ".$bnk->banka_hesapAd; ?></option>
															<?php }	?>
														</select>
													</div>
												</div>
													...
													<div class="form-group">
														...
														<select class="select form-control" name="kasa_id" id="kasa">
															...
															<?php foreach($kasa as $ksa){?>
																<option value="<?= $ksa->kasa_id; ?>" <?php if($ksa->kasa_id == $alisFaturasi->alis_kasaID){echo "selected";} ?>> <?= $ksa->kasa_adi; ?></option>
															<?php }	?>
														</select>
													</div>
												</div>
...
?>
	<tr>
		...
		<td><input type='number' step='0.01' class='form-control' autocomplete='off' name='miktar[]' id='miktar<?= $x; ?>' required='' value="<?= $stok->alisStok_miktar; ?>"></td>
		<td><input type='text' class='form-control' name='birim[]' id='birim<?= $x; ?>' readonly value="<?= $stokbirimexe->stokBirim_ad;?>"></td>
		<td><input type='number' step='0.01' class='form-control' autocomplete='off' name='birimfiyat[]' id='birimfiyat<?= $x; ?>' required='' value="<?= $stok->alisStok_birimFiyat; ?>"></td>
