				...
				<div class="row">
					<div class="col-sm-10">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item active">E-Arşiv Fatura Oluştur</li>
						</ul>
					</div>
						...
						<div class="card-body">
							...
							<form action="<?= base_url("fatura/satisFaturasiGuncelle/"); ?>" method="POST" id="myForm">
								...
								<form action="<?= base_url("fatura/satisFaturasiOlustur"); ?>" method="POST"
									  id="myForm">
									<?php } ?>
									<input type="hidden" name="satis_InvoiceType" value="2">
										...
										<div class="col-12">
											<div class="row">
												<div class="col-md-7">													<div class="col-md-12" style="display: none;">
														<div class="form-group row">
															...
															<div class="col-sm-9">
																<select class="form-control"
																		name="satis_earsivfaturaTip"
																		id="satis_earsivfaturaTip" required="">
													...
													<div class="col-md-12">
														<div class="form-group row">
															<label class="col-sm-3 text-sm-left pt-2">E-Arşiv
																Tipi</label>
															<div class="col-sm-9">
																<select class="form-control select" id="earsivtipi"
																		name="satis_earsivTipi" required=""
																		onchange="javascript: if(this.value=='2')document.getElementById('gonderimsekli').value='2';">
																	<option value="1" <?php if ($faturaDetay->satis_earsivTipi == 1) echo "selected"; ?>>
																		NORMAL
																	</option>
																	<option value="2" <?php if ($faturaDetay->satis_earsivTipi == 2) echo "selected"; ?>>
																		İNTERNET
																	</option>
																</select>
															</div>
													...
													<div class="col-md-12">
														<div class="form-group row">
															<label class="col-sm-3 text-sm-left pt-2">Gönderim
																Şekli</label>
															<div class="col-sm-9">
																<select class="form-control " id="gonderimsekli"
																		name="satis_earsivGonderimSekli" required=""
																		onchange="javascript: if(document.getElementById('earsivtipi').value=='2')document.getElementById('gonderimsekli').value='2';">
																	<option value="1" <?php if ($faturaDetay->satis_earsivGonderimSekli == 1) echo "selected"; ?>>
																		KAĞIT
																	</option>
																	<option value="2" <?php if ($faturaDetay->satis_earsivGonderimSekli == 2) echo "selected"; ?>>
																		ELEKTRONİK
																	</option>
																</select>
															</div>
														...
														<div class="form-group row">
															...
															<div class="col-sm-9">
																<input type="text" class="datepicker form-control"
																	   ...
																	   required=""
																	   value="<?php if ($faturaDetay->satis_faturaSaati == null)
														...
														<div class="form-group row">
															...
															<div class="col-sm-9">
																<input type="text" class="form-control"
																	   ...
																	   value="<?php if ($faturaDetay->satis_faturaSaati == null)
																		   echo getirSaat(); else echo $faturaDetay->satis_faturaSaati ?>"
																	   id="datetimepicker"/>
															</div>
														</div>
													</div>
										...
										<div class="row pl-4">
											<div class="col-md-4">
												...
												<input class="form-check-input" type="checkbox" value="1"
													   id="epostaCheck"
													   name="epostaCheck" style="width:30px;height:20px;">
												<label class="form-check-label ml-3" for="epostaCheck">
													E-Posta Olarak<br> İletilsin
												</label>
									...
									<div class="row"
										 id="eposta_bilgi" <?php if (!$earsivInternet) echo 'style="display: none;"'; ?>>
										<div class="col-md-12">
											<h4 class="card-title mt-4">E Posta Bilgisi </h4>
											<p style="color:green">
												<input type="hidden" name="earsiv_internet" id="earsiv_internet"
													   value="<?= $earsivInternet->earsiv_id ?>">
												Birden fazla e-posta adresini aralarına virgül (,) koyarak
												girebilirsiniz.
											</p>
											<div class="row">
												<label class="col-md-2">E-Posta Adresi</label>
												<input type="text" class="form-control col-md-4" name='eposta_bilgi'
													   id='eposta_bilgi_input' <?php if ($earsivInternet) echo 'required value="' . $earsivInternet->earsiv_eposta . '"'; else echo "value='" . $cari->cari_firmaEPosta . "'" ?> >
											</div>
									...
									<div class="" id="internet_div" <?php if (
											!$earsivInternet || $earsivInternet->earsiv_odemesekli == 0) echo ' style="display:none;"'; ?>>
										<div class="row">

											<div class="col-md-6">
												<h4 class="card-title mt-4">Ödeme Bilgisi</h4>

												<div class="col-md-12">
													<div class="form-group row">
														<label class="col-sm-4 text-sm-left pt-2">Ödeme Şekli</label>
														<div class="col-sm-8">
															<select class="form-control select" name="satis_odemesekli"
																	id="satis_odemesekli">
																<option value="">Seçiniz...</option>
																<option value="48" <?php if ($earsivInternet->earsiv_odemesekli == 48) echo "selected"; ?>>
																	KREDIKARTI/BANKAKARTI
																</option>
																<option value="46" <?php if ($earsivInternet->earsiv_odemesekli == 46) echo "selected"; ?>>
																	EFT/HAVALE
																</option>
																<option value="10" <?php if ($earsivInternet->earsiv_odemesekli == 10) echo "selected"; ?>>
																	KAPIDAODEME
																</option>
																<option value="1" <?php if ($earsivInternet->earsiv_odemesekli == 1) echo "selected"; ?>>
																	DIGER
																</option>
															</select>
														</div>
												...
												<div class="col-md-12">
													<div class="form-group row">
														<label class="col-sm-4 text-sm-left pt-2">Aracı</label>
														<div class="col-sm-8">
															<input type="text" class="form-control"
																   name="satis_odemearaci"
																   id="satis_odemearaci" autocomplete="off"
																   value="<?= $earsivInternet->earsiv_odemearaci ?>"/>
														</div>
													</div>
												</div>
												...
												<div class="col-md-12">
													<div class="form-group row">
														<label class="col-sm-4 text-sm-left pt-2">Tarihi</label>
														<div class="col-sm-8">
															<input type="text" class="datepicker form-control"
																   name="satis_odemetarihi" id="satis_odemetarihi"
																   autocomplete="off"
																   value="<?= $earsivInternet->earsiv_odemetarihi ?>"/>
														</div>
													</div>
												</div>
												...
												<div class="col-md-12">
													<div class="form-group row">
														<label class="col-sm-4 text-sm-left pt-2">İnternet Satış
															Bilgisi</label>
														<div class="col-sm-8">
															<input type="text" class="form-control"
																   name="satis_internetsatisbilgisi"
																   id="satis_internetsatisbilgisi" autocomplete="off"
																   value="<?= $earsivInternet->earsiv_internetsatisbilgisi ?>"/>
														</div>
													</div>
												</div>
											...
											<div class="col-md-6">
												<h4 class="card-title mt-4">Gönderim Şekli</h4>
												<div class="col-md-12">
													<div class="form-group row">
														<label class="col-sm-4 text-sm-left pt-2">Taşıyan</label>
														<div class="col-sm-8">
															<select class="form-control select" name="satis_tasiyan"
																	id="satis_tasiyan"">
															<option value="1" <?php if ($earsivInternet->earsiv_otasiyan == 1) echo "selected"; ?>>
																Gerçek
															</option>
															<option value="2" <?php if ($earsivInternet->earsiv_otasiyan == 2) echo "selected"; ?>>
																Tüzel
															</option>
															</select>
														</div>
												...
												<div class="col-md-12">
													<div class="form-group row">
														<label class="col-sm-4 text-sm-left pt-2">Taşıyan
															VKN/TCKNO</label>
														<div class="col-sm-8">
															<input type="number" class="form-control"
																   name="satis_tasiyanvkntckn"
																   maxlength="11" id="satis_tasiyanvkntckn"
																   value="<?= $earsivInternet->earsiv_tasiyanvkntckn ?>">
														</div>
													</div>
												</div>
												...
												<div class="col-md-12">
													<div class="form-group row">
														<label class="col-sm-4 text-sm-left pt-2">Taşıyan Unvan</label>
														<div class="col-sm-8">
															<input type="text" class="form-control"
																   name="satis_tasiyanunvan" id="satis_tasiyanunvan"
																   autocomplete="off"
																   value="<?= $earsivInternet->earsiv_tasiyanunvan ?>"/>
														</div>
													</div>
												</div>
												...
												<div class="col-md-12">
													<div class="form-group row">
														...
														<div class="col-sm-8">
															<input type="text" class="datepicker form-control"
																   name="satis_tasiyantarih" id="satis_tasiyantarih"
																   autocomplete="off"
																   value="<?= $earsivInternet->earsiv_tasiyantarih ?>"/>
														</div>
													</div>
												</div>
													...
													<table class="table table-bordered custom-table mb-0" id="my_table">
														...
														foreach ($iadeFaturalari as $itemIade) {
															...
															<tr>
																<td>Numarası</td>
																<td>
																	<input type="hidden" name="iade_id[]"
																		   value="<?= $itemIade->iade_fat_no_id; ?>">
																	<input type='text' class='form-control'
																		   name='iadenumara[]'
															...
															<script>
																...
																document.getElementById("iade_count").value = items_iade;</script>
															<?
														}
														?>
															...
															<table class="table table-bordered custom-table mb-0"
																...
																foreach ($genelIskonto as $itemIskonto) {
																	...
																	<script>items_indirim++;
																		...
																		document.getElementById("indirim_count").value = items_indirim;</script>
																<?php }
																?>
																</tbody>
															</table>
...
<script>
	...
	$("#satis_earsivfaturaTip").on('change', function () {
		var val = $(this).val();
	...
	$("#epostaCheck").on('change', function () {
		if (document.getElementById("epostaCheck").checked == true) {
			$('#eposta_bilgi').attr('style', 'display:block;');
			document.getElementById("eposta_bilgi_input").required = true;
		} else {
			$('#eposta_bilgi').attr('style', 'display:none;');
			document.getElementById("eposta_bilgi_input").required = false;
			$("#eposta_bilgi_input").val("");
		}
	...
	$("#gonderimsekli").on('change', function () {

		var val = $("#gonderimsekli").val();
		if (val == 2) {
			$('#eposta_bilgi').attr('style', 'display:block;');
			document.getElementById("eposta_bilgi_input").required = true;
			document.getElementById("epostaCheck").checked = true;
			document.getElementById("epostaCheck").disabled = true;
		} else {
			$('#eposta_bilgi').attr('style', 'display:none;');
			document.getElementById("eposta_bilgi_input").required = false;
			document.getElementById("epostaCheck").checked = false;
			document.getElementById("epostaCheck").disabled = false;
			$("#eposta_bilgi_input").val("");
		}
	});

	$("#earsivtipi").on('change', function () {
		var val = $("#earsivtipi").val();
		if (val == 2) {
			$('#internet_div').attr('style', 'display:block;');
			$('#eposta_bilgi').attr('style', 'display:block;');
			document.getElementById("eposta_bilgi_input").required = true;
			document.getElementById("satis_odemesekli").required = true;
			document.getElementById("satis_odemearaci").required = true;
			document.getElementById("satis_odemetarihi").required = true;
			document.getElementById("satis_internetsatisbilgisi").required = true;
			document.getElementById("satis_tasiyan").required = true;
			document.getElementById("satis_tasiyanvkntckn").required = true;
			document.getElementById("satis_tasiyanunvan").required = true;
			document.getElementById("satis_tasiyantarih").required = true;
		} else {

			$('#internet_div').attr('style', 'display:none;');

			document.getElementById("satis_odemesekli").required = false;
			document.getElementById("satis_odemearaci").required = false;
			document.getElementById("satis_odemetarihi").required = false;
			document.getElementById("satis_internetsatisbilgisi").required = false;
			document.getElementById("satis_tasiyan").required = false;
			document.getElementById("satis_tasiyanvkntckn").required = false;
			document.getElementById("satis_tasiyanunvan").required = false;
			document.getElementById("satis_tasiyantarih").required = false;

			$("#satis_odemesekli").val("");
			$("#satis_odemearaci").val("");
			$("#satis_odemetarihi").val("");
			$("#satis_internetsatisbilgisi").val("");
			$("#satis_tasiyan").val("");
			$("#satis_tasiyanvkntckn").val("");
			$("#satis_tasiyanunvan").val("");
			$("#satis_tasiyantarih").val("");
		}
	});
