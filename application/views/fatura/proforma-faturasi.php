				...
				<div class="row">
					<div class="col-sm-10">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item active">Proforma Faturası Oluştur</li>
						</ul>
					</div>
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-body">
							...
							<form action="<?= base_url("fatura/proformaFaturasiGuncelle/"); ?>" method="POST" id="myForm">
								<?php }
								else{//ekle
								?>
								<form action="<?= base_url("fatura/proformaFaturasiOlustur"); ?>" method="POST" id="myForm">
									<?php
									}
									?>
									<input type="hidden" name="proforma_id" value="<?= $faturaDetay->proforma_id ?>">
									<input type="hidden" name="proforma_cariID" id="cari_id" value="<?= $cari->cari_id ?>">
									<input type="hidden" name="ch_id" id="ch_id"
										   value="<?= $faturaDetay->proforma_cariHareketiID; ?>">
														...
														<div class="form-group row">
															...
															<div class="col-sm-9">
																<input type="text" class="form-control"
																	   ...
																	   value="<?= $faturaDetay->proforma_faturaNo ?>">
															</div>
													...
													<div class="col-md-12">
														<div class="form-group row">
															...
															<div class="col-sm-9" id="proforma_faturaTip_div">
																<select class="form-control" name="proforma_faturaTip"
																		id="proforma_faturaTip" required="">
																	<option value="1" <?php if ($faturaDetay->proforma_faturaTipi == 1) echo "selected"; ?>>
																		SATIŞ
																	</option>
																	<option value="2" <?php if ($faturaDetay->proforma_faturaTipi == 2) echo "selected"; ?>>
																		İADE
																	</option>
																	<option value="3" <?php if ($faturaDetay->proforma_faturaTipi == 3) echo "selected"; ?>>
																		TEVKİFAT
																	</option>
																	<option value="4" <?php if ($faturaDetay->proforma_faturaTipi == 4) echo "selected"; ?>>
																		İSTİSNA
																	</option>
																	<option value="5" <?php if ($faturaDetay->proforma_faturaTipi == 5) echo "selected"; ?>>
																		İADE-İSTİSNA
																	</option>
																	<option value="6" <?php if ($faturaDetay->proforma_faturaTipi == 6) echo "selected"; ?>>
																		ÖZEL MATRAH
																	</option>
																</select>
															</div>
														...
														<div class="form-group row">
															...
															<div class="col-sm-5">
																<select class="form control select"
																		name="proforma_paraBirimi"
																		id="proforma_paraBirimi">
																	<option value="1" <?php if ($faturaDetay->proforma_paraBirimi == 1) {
																		echo "selected";
																		$paraBirimi = "TL";
																	} ?>>
																		Türk Lirası
																	</option>
																	<option value="2" <?php if ($faturaDetay->proforma_paraBirimi == 2) {
																		echo "selected";
																		$paraBirimi = "USD";
																	} ?>>
																		Amerikan Doları
																	</option>
																	<option value="3" <?php if ($faturaDetay->proforma_paraBirimi == 3) {
																		echo "selected";
																		$paraBirimi = "EUR";
																	} ?>>
																		Euro
																	</option>
																	<option value="4" <?php if ($faturaDetay->proforma_paraBirimi == 4) {
																		echo "selected";
																		$paraBirimi = "GBP";
																	} ?>>
																		İngiliz Sterlini
															...
															<div class="col-sm-4">
																<input type="text" name="proforma_guncelKur"
																	   id="proforma_guncelKur"
																	   class="form-control" placeholder="Döviz kuru"
																		<?php if ($faturaDetay->proforma_guncelKur == null) echo 'style="display:none;"'; ?>
																	   value="<?= $faturaDetay->proforma_guncelKur ?>"/>
															</div>
														</div>
													</div>
														...
														<div class="form-group row">
															...
															<div class="col-sm-9">
																<input type="text" class="datepicker form-control"
																	   id="duzenlemeTarihi"
																	   name="proforma_faturaTarihi" autocomplete="off"
																	   required=""
																	   value="<?= getirBugun(); ?>"/>
															</div>
														</div>
													...
													<div class="col-md-12">
														<div class="form-group row">
															...
															<div class="col-sm-9">
																...
																<input type="text" class="form-control"  id="proforma_faturaEtiketID"
																	   name="proforma_faturaEtiketID"
									...
									<div class="row"
										...
										<div class="col-md-12">
												...
												<div class="table-responsive">
													<table class="table table-bordered custom-table mb-0"
														...
														foreach ($stok as $item) {
															...
															$tevkifatVal = 0;
															$tevkifatOran = 0;
															if ($item->proformaStok_tevkifatID != 0) {
																$sqlTevkifat = "select * from tevkifatKodlari inner join proformaFaturasiStok on tevkifat_id=proformaStok_tevkifatID where proformaStok_id=" . $item->proformaStok_id;
															...
															<tr>
																<td>
																	<input type="hidden"
																		   name="proformaFaturasiStok_id[]"
																		   value="<?= $item->proformaStok_id; ?>">
																...
																<td>
																	<input type='hidden' name='stokid[]'
																		   id='stokid<?= $items ?>'
																		   value="<?= $item->proformaStok_stokID ?>">
																	<input type='text' class='form-control'
																...
																<td>
																	<input type='number' step='0.1'
																		   ...
																		   style='width:175px;'
																		   value="<?= $item->proformaStok_miktar ?>">
																</td>
																<td>
																	<input type='number' step='0.1'
																		   class='form-control'
																		   ...
																		   value="<?= $item->proformaStok_birimFiyat ?>">
																</td>
																<td>
																	<select class='form-control' name='kdv[]'
																			id='kdv<?= $items ?>'>
																		<option value='0' <?php if ($item->proformaStok_kdv == 0) echo "selected"; ?>>
																			0
																		</option>
																		<option value='1' <?php if ($item->proformaStok_kdv == 1) echo "selected"; ?>>
																			1
																		</option>
																		<option value='8' <?php if ($item->proformaStok_kdv == 8) echo "selected"; ?>>
																			8
																		</option>
																		<option value='10' <?php if ($item->proformaStok_kdv == 10) echo "selected"; ?>>
																			10
																		</option>
																		<option value='18' <?php if ($item->proformaStok_kdv == 18) echo "selected"; ?>>
																			18
																		</option>
																		<option value='20' <?php if ($item->proformaStok_kdv == 20) echo "selected"; ?>>
																			20
																		</option>
																	</select>
																</td>
																<td>
																	...
																	<input type='text' class='form-control'
																		   ...
																		   value="<?= $item->proformaStok_indirimlifiyat ?>">
															...
															<td id='indirimytd<?= $items ?>' <?php if ($item->proformaStok_satirIskonto == 0) echo "style='display: none;'"; ?>>
																<label>İndirim (%)</label>
																<input type='number' step='0.1' class='form-control'
																	   placeholder='İndirim (%)'
																	   name='indirimyuzde[]'
																	   id='indirimyuzde<?= $items ?>'
																		<?php if ($item->proformaStok_indirimTutari != 0) echo ' value="' . $item->proformaStok_indirimTutari . '"'; ?>>
															</td>
															<td id='tevkifatselecttd<?= $items ?>' <?php if ($item->proformaStok_tevkifat_id == 0) echo "style='display: none;'"; ?>>
															...
															<td id='tevkifattexttd<?= $items ?>' <?php if ($item->proformaStok_tevkifatID == 0) echo "style='display: none;'"; ?>>
											...
											<div class="row"
												 id="vergiMuafiyet" <?php if ($faturaDetay->proforma_vergiMuafiyetSebep == "") echo 'style="display: none;"'; ?>>
												<div class="col-md-12">
														...
														<tr>
															...
															<td>
																<input type="text" name="vergiMuafiyet_sebep"
																	   ...
																	   value="<?= $faturaDetay->proforma_vergiMuafiyetSebep ?>">
															</td>
														</tr>
													</table>
												</div>
											...
											<div class="row"
												 id="istisna_table" <?php if ($faturaDetay->proforma_istisnaID == 0) echo 'style="display: none;"'; ?>>
												<div class="col-md-12">
													<h4 class="card-title mt-4">VERGİ MUAFİYET </h4>
												...
												<div class="table-responsive">
													...
													<table class="table table-stripped table-center table-hover">
														...
														<tr>
															...
															<td class="text-right"
																id="aratop"><?= $faturaDetay->proforma_araToplam . " " . $paraBirimi ?></td>
														</tr>
														<tr>
															<td></td>
															<td></td>
															...
															<td class="text-right"
																id="indirimtop"><?= $faturaDetay->proforma_indirimToplam . " " . $paraBirimi ?></td>
														</tr>
														<tr>
															<td></td>
															<td></td>
															...
															<td class="text-right"
																id="nettutartop"><?= $faturaDetay->proforma_netTutar . " " . $paraBirimi ?></td>
														</tr>
														<tr>
															<td></td>
															<td></td>
															...
															<td class="text-right"
																id="kdvtop"><?= $faturaDetay->proforma_kdvToplam . " " . $paraBirimi ?></td>
														</tr>
														<tr>
															<td></td>
															<td></td>
															...
															<td class="text-right"
																id="kdvtevkifat"><?= $faturaDetay->proforma_tevkifatToplam . " " . $paraBirimi ?></td>
														</tr>
														<tr>
															<td></td>
															<td></td>
															...
															<td class="text-right"
																id="vergidahil"><?= $faturaDetay->proforma_vergiDahilToplam . " " . $paraBirimi ?></td>
														</tr>
														<tr>
															<td></td>
															<td></td>
															...
															<td class="text-right"
																id="geneltop"><?= $faturaDetay->proforma_genelToplam . " " . $paraBirimi ?></td>
														</tr>
														</tbody>
													</table>
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<textarea class="form-control"
																  name="proforma_aciklama"><?= $faturaDetay->proforma_aciklama ?></textarea>
													</div>
												</div>
											</div>
				...
				<form action="<?= base_url("cari/yeniCariKartiOlustur"); ?>" method="POST" id="myForm">
					<div class="row">
						<div class="form-group col-md-12">
							<input type="hidden" name="page" value="proformafatura">
						...
						<div class="row p-3">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="cari_kodu_yeni" id="cari_kodu"
										   required=""
...
<script>
	...
	<?php
	if ($faturaDetay) {
		echo "document.getElementById('istisna_sebebi').value='" . $faturaDetay->proforma_istisnaID . "';";
	}


	if ($faturaDetay->proforma_faturaTipi == 3)
	...
	function addItem() {
		...
		$("#stokadi" + items).autocomplete({
			...
			select: function (event, ui) {
				...
				$("#birim" + idsi).css("background-color", "#e9ecef");
				var tip = $("#proforma_faturaTip").val();
...
*/
		...
		for (i = 1; i <= items; i++) {
			...
			if (satir.length >= 1) {
				...
				/*
									...
									$("#vergidahil").html(geneltop);
									$("#vergidahilHidden").val(geneltop);

									geneltop = geneltop - tevkifattop;

									$("#aratop").html(aratop);
									$("#aratopHidden").val(aratop);
									$("#kdvtop").html(kdvtop);
									$("#kdvtopHidden").val(kdvtop);
									$("#geneltop").html(geneltop);
									$("#geneltopHidden").val(geneltop);

									$("#netTutarInput").val(nettop);

									$("#nettutartop").html(nettop);

									$("#indirimtop").html(indirimtop);
									$("#indirimtopHidden").val(indirimtop);

									$("#kdvtevkifat").html(tevkifattop);
									$("#tevkifattopHidden").val(tevkifattop);
				*/
				nettop = aratop - indirimtop;
				geneltop = nettop + kdvtop;
	...
	$(function () {
		$("#tcknvkn_input").autocomplete({
			...
			select: function (event, ui) {
				...
				$("#checkboxDiv").css("display", "block");
				$("#stokBilgisiDiv").css("display", "block");
				$("#toplamlarDiv").css("display", "block");
	...
	$(function () {
		$("#proforma_faturaEtiketID").autocomplete({
			source: "<?= env('BASE_URL'); ?>/fatura/autocompleteDataByEtiket",
			minLength: 2,
			select: function (event, ui) {
				event.preventDefault();
				$("#etiket_id").val(ui.item.id);
				$("#proforma_faturaEtiketID").val(ui.item.value);
			}
		});
	});
...
<script>
	...
	$("#proforma_paraBirimi").on('change', function () {
		var paraBirimiText = $("#proforma_paraBirimi option:selected").text();
		var paraBirimi = $("#proforma_paraBirimi option:selected").val();

		if (paraBirimi == 1) {
			$("#proforma_guncelKur").css("display", "none");
			$("#proforma_guncelKur").val("");
			...
			$("#proforma_guncelKur").css("display", "block");
			$.ajax({
...
<script>
	...
	$("#proforma_faturaTip").on('change', function () {
		var val = $(this).val();
...
<script>
	...
	function etiketKontrol() {
		...
		var etiket_adi=$("proforma_faturaEtiketID").val();
		if(!etiket_adi) {
			etiket_id = "";
			$("#etiket_id").val("");
		}
		...
		if (etiket_id == "")
			$("#proforma_faturaEtiketID").css("background-color", "#dff1e7");
		else
			$("#proforma_faturaEtiketID").css("background-color", "#e9ecef");
	}
</script>
