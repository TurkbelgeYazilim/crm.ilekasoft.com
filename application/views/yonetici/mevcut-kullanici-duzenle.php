...
<head>
	...
	<body>
						...
						<div class="col-md-12">
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<h4 class="card-title mt-4">İller Yetkisi</h4>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label>Kullanıcının Yetki Verilen İller</label>												<select class="form-control select2-multiple" name="il_yetkisi[]" multiple="multiple" id="il-yetkisi-select">
													<option value="">İl seçiniz...</option>
													<?php if(isset($iller) && !empty($iller)): ?>
														<?php foreach($iller as $il): ?>
															<option value="<?= $il->id; ?>" 
																<?php 
																	if(isset($kullaniciIlYetkileri) && !empty($kullaniciIlYetkileri)):
																		foreach($kullaniciIlYetkileri as $yetki):
																			if($yetki->il_id == $il->id && $yetki->durum == 1):
																				echo "selected";
																				break;
																			endif;
																		endforeach;
												...
												<small class="form-text text-muted">Kullanıcının hangi illerde işlem yapabileceğini belirleyin. Çoklu seçim yapabilirsiniz.</small>
											</div>
										</div>
									</div>
		...
		$(document).ready(function() {
			// Select2 başlatma - İller Yetkisi için
			$('#il-yetkisi-select').select2({
