						...
						<div class="row">
							<div class="col-sm-10">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Azalan Ürünler (Kritik Stok)</li>
								</ul>
							</div>
						...
						<div class="col-xl-12 col-md-12">
							<div class="card card-table">
								<div class="card-header">
									<div class="row">
										<div class="col">
											<h5 class="card-title">Azalan Ürünler (Kritik Stok)</h5>
										</div>
									</div>
								</div>
								<div class="card-body">
										...
										<table class="table table-striped custom-table mb-0">
											...
											<tbody>
												...
												<tr style="color:red!important;">
													<td><a style="color:red!important;font-weight: bolder;" href="<?= base_url("stok/stok-hareketleri?stok=$st->stok_id"); ?>"><?= $st->stok_kodu;?></a></td>
													<td><?= $st->stok_ad;?></td>
