						...
						<div class="row">
							<div class="col-sm-10">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Kasa Ödeme İşlemi Düzenle</li>
								</ul>
							</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<form action="<?= base_url("kasa/kasaOdemeGuncelle"); ?>" method="POST">
										<input type="hidden" name="kh_id" value="<?= $odeme->kh_id; ?>">
										...
										<input type="hidden" name="ch_id" id="ch_id" value="<?= $odeme->kh_cariHareketiID; ?>">
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label>Belge / Makbuz No</label>
													<input type="text" class="form-control" name="odeme_belgeNo" required="" value="<?=$odeme->kh_belgeNumarasi; ?>">
												</div>
											</div>
											...
											<!--<div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="odeme_kasaAdi" required="" id="ad_input" value="<?= $kasaExe->kasa_adi; ?>">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Kasa Kodu</label>
													<input type="text" class="form-control" name="odeme_kasaKodu" required="" id="kod_input" value="<?= $kasaExe->kasa_kodu; ?>">
												</div>
											</div> -->
											<div class="col-md-6">
												<div class="form-group">
													<label>Cari Adı</label>
													<input type="text" class="form-control" name="odeme_cariAdi" required="" id="cariadi_input" value="<?= $cariExe->cari_ad; ?>">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Cari Kodu</label>
													<input type="text" class="form-control" name="odeme_cariKodu" required="" id="carikodu_input" value="<?= $cariExe->cari_kodu; ?>">
												</div>
											</div>
											
										</div>
										<?php 
											$tarih = $odeme->kh_tarih;
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label>Tarih</label>
													<input type="text" class="datepicker form-control" name="odeme_tarih" required="" value="<?= $yeni_tarih; ?>" autocomplete="off">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Tutar</label>
													<input type="number" step="0.01" class="form-control" name="odeme_tutar" required="" value="<?php if(!empty($odeme->kh_giris)){echo $odeme->kh_giris;} else if(!empty($odeme->kh_cikis)){echo $odeme->kh_cikis;} ?>">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label>Açıklama</label>
													<textarea class="form-control" name="odeme_aciklama"><?= $odeme->kh_aciklama; ?></textarea>
												</div>
											</div>
										</div>
...
<?php if ($this->session->flashdata('kasa_odeme_ok')): ?>
<script>
swal({
  title: "Bilgilendirme",
  type: "success", 
  text: "Kasa ödeme işlemi başarılı bir şekilde gerçekleştirildi.",
...
<?php if ($this->session->flashdata('kasa_odeme_updt_ok')): ?>
<script>
swal({
  title: "Bilgilendirme",
  type: "success", 
  text: "Kasa ödeme işlemi başarılı bir şekilde güncellendi.",
  confirmButtonText:'Tamam',
  button: false,
  timer: 5000,
});
