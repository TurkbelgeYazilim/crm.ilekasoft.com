						...
						<div class="row">
							<div class="col-sm-10">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Kasa Virman</li>
								</ul>
							</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<form action="<?= base_url("kasa/yeniKasaVirman"); ?>" method="POST">
										<!-- <input type="hidden" name="kasa_id" id="kasa_id">
										<input type="hidden" name="kasa_id2" id="kasa_id2"> -->
										...
										<div class="row">
											...
											<div class="col-md-8">
												<div class="form-group">
													...
													<!--<input type="text" class="form-control" name="virman_kaynakKasaAdi" required="" id="ad_input"> -->
												</div>
											</div>
											<!-- <div class="col-md-4">
												<div class="form-group">
													<label>Kaynak Kasa Kodu</label>
													<input type="text" class="form-control" name="virman_kaynakKasaKodu" required="" id="kod_input">
												</div>
											</div> -->
										...
										<div class="row">
											...
											<!-- <div class="col-md-4">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="virman_hedefKasaKodu" required="" id="kod_input2">
												</div>
											</div> -->
