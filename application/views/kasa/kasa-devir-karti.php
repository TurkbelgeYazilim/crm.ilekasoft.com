						...
						<div class="row">
							<div class="col-sm-10">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Kasa Devir Kartı</li>
								</ul>
							</div>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<form action="<?= base_url("kasa/yeniKasaDevirKarti"); ?>" method="POST">
										<input type="hidden" name="kasa_id" id="kasa_id">
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label>Belge No</label>
													<input type="text" class="form-control" name="devir_belgeNo" required="">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Kasa Adı</label>
													<input type="text" class="form-control" name="devir_kasaAdi" required="" id="ad_input">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Kasa Kodu</label>
													<input type="text" class="form-control" name="devir_kasaKodu" required="" id="kod_input">
												</div>
											</div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label>Tarih</label>
													<input type="text" class="datepicker form-control" name="devir_tarih" required="" autocomplete="off" value="<?= getirBugun(); ?>">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label>Tutar</label>
													<input type="number" step="0.01" class="form-control" name="devir_tutar" required="">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													...
													<select name="devir_islemTipi" class="select form-control" required="">
														...
														<option value="1">Giriş işlemi</option>
														<option value="2">Çıkış işlemi</option>
													</select>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													...
													<textarea class="form-control" name="devir_aciklama"></textarea>
												</div>
											</div>
										</div>
