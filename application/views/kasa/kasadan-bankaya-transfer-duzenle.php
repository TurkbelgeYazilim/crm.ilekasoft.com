						...
						<div class="row">
							<div class="col-sm-10">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Kasadan Bankaya Transfer Düzenle</li>
								</ul>
							</div>
		...
		<a class="btn btn-outline-light" href="javascript:history.back()"><i class="fa fa-history"></i> <br>Önceki Sayfa</a>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Kasa ve Banka Bilgileri Düzenle</h4>
									<form action="<?= base_url("kasa/kasadanBankayaTransfer_Duzenle"); ?>" method="POST">
										<input type="hidden" name="kh_transferRefID" value="<?= $kasaTransfer->kh_transferRefID;?>">

										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label>Belge / Makbuz No</label>
													<input type="text" class="form-control" name="kasaToBankaTransfer_belgeNo" required="" value="<?= $kasaTransfer->kh_belgeNumarasi; ?>">
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>Kasa seçiniz... <i>(Kaynak)</i></label>
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>Banka seçiniz... <i>(Hedef)</i></label>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label>Tarih</label>
													<input type="text" class="datepicker form-control" name="kasaToBankaTransfer_tarih" required="" autocomplete="off" value="<?= $yeni_tarih; ?>">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Tutar</label>
													<input type="number" step="0.01" class="form-control" name="kasaToBankaTransfer_tutar" required="" value="<?= $kasaTransfer->kh_cikis; ?>">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label>Açıklama</label>
													<textarea class="form-control" name="kasaToBankaTransfer_aciklama"><?= $kasaTransfer->kh_aciklama; ?></textarea>
												</div>
											</div>
										</div>
...
<?php if ($this->session->flashdata('kasadan_bankaya_transfer_ok')): ?>
	<script>
		swal({
			title: "Bilgilendirme",
			type: "success",
			text: "Kasadan bankaya transfer işlemi başarılı bir şekilde yapıldı.",
			confirmButtonText:'Tamam',
			button: false,
			timer: 5000,
		});
...
<?php if ($this->session->flashdata('kasadan_bankaya_transfer_update')): ?>
	<script>
		swal({
			title: "Bilgilendirme",
			type: "success",
			text: "Kasadan bankaya transfer işlemi güncellemesi yapıldı.",
			confirmButtonText:'Tamam',
			button: false,
			timer: 5000,
		});
