						...
						<div class="row">
							<div class="col-sm-10">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Kasa Listesi</li>
								</ul>
							</div>
						...
						<div class="col-xl-12 col-md-12">
							<div class="card card-table">
								<div class="card-header">
									<div class="row">
										<div class="col">
											<h5 class="card-title">Kasa Listesi</h5>
										</div>
										<div class="col-auto">
									    ...
									    $tumToplam=0;
												...
												<tr>
													...
													<td class="text-right">
														...
														<a href="<?= base_url("kasa/kasa-acilis-karti-duzenle/$ks->kasa_id"); ?>"  class="btn btn-sm btn-white text-success mr-2"><i class="far fa-edit mr-1"></i> Düzenle</a> 
														<!--
...
<span style="margin-left:15px;">Toplam kayıt sayısı:</span> <b><?= $count_of_list; ?></b>
								...
								<span style="margin-left:15px;">Toplam durum: <b><?= number_format($tumToplam, 2); ?></b></span>
<br><br>
									</div>
								</div>
							</div>
						...
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								...
								<div class="modal-body">
									<form action="<?= base_url("kasa/kasa-listesi"); ?>" method="GET">
