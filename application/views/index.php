											...
											<ul class="activity-feed">
												<?php foreach ($fatura as $item) {
													...
													<span class="feed-text">
														<a href="<?= base_url($link . $item->id) ?>" title="<?= $title ?>">
															<!-- Müşteri adı, tutar ve para birimi birlikte gösteriliyor -->
															<strong><?= strtoupper($item->cari_ad) ?></strong>
															- <?= $item->genelToplam . " " . $paraBirimi ?>
															<br>
															<small><?= $title ?></small>
														</a>
													</span>
								...
								<div class="col-md-3 col-lg-3 col-sm-6">
									<div class="widget widget-stats bg-light-warning mb-7px">
										...
										<div class="stats-content">
											<div class="stats-title">Satış Adedi</div>
