										...
										<?php foreach($yanitlar as $yanit){ ?>
												...
												<li class="media sent">
													<div class="media-body">
														<div class="msg-box">
															<div>
																<p><?php if($yanit->dyanit_resim != NULL){ ?><a href="<?= base_url("assets/bulut/tickets/$yanit->dyanit_resim"); ?>" target="_blank" style="color:#AAA!important;"><i class="fas fa-paperclip"></i></a><?php }?> <?= nl2br(htmlspecialchars($yanit->dyanit_mesaj)); ?></p>
