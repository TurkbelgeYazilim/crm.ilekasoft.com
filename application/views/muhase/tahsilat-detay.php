				...
				<div class="row">
					<div class="col-sm-10">
						...
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="<?= base_url('muhasebe/onay-bekleyen-tahsilatlar'); ?>">Onay Bekleyen Tahsilatlar</a></li>
							<li class="breadcrumb-item active">Tahsilat Detayı</li>
						</ul>
					</div>
					<div class="d-flex justify-content-end text-align-center col-sm-2">
						<a class="btn btn-outline-light" href="<?= base_url('muhasebe/onay-bekleyen-tahsilatlar'); ?>">
