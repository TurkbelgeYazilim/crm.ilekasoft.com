            ...
            <div class="content container-fluid">
                ...
                $(function(){
                    ...
                    function sezonlariGetir() {
                        $.getJSON('illegal/sezonlar-listele', function(resp){
                            var html = '';
                    ...
                    function cariGruplariGetir() {
                        $.getJSON('illegal/cari-gruplar-listele', function(resp){
                            var html = '';
                    ...
                    function sektorleriGetir() {
                        $.getJSON('illegal/sektorler-listele', function(resp){
                            var html = '';
                    ...
                    $('#sezonEkleForm').on('submit', function(e){
                        ...
                        $.post('illegal/sezon-ekle', {sezon_adi: ad}, function(){
                            sezonlariGetir();
                    ...
                    $('#cariGrupEkleForm').on('submit', function(e){
                        ...
                        $.post('illegal/cari-grup-ekle', {cari_grup: ad}, function(){
                            cariGruplariGetir();
                    ...
                    $('#sektorEkleForm').on('submit', function(e){
                        ...
                        $.post('illegal/sektor-ekle', {sektor_adi: ad}, function(){
                            sektorleriGetir();
                    ...
                    $(document).on('click', '.sezon-sil', function(){
                        if(confirm('Sezon silinsin mi?')){
                            $.post('illegal/sezon-sil', {sezon_id: $(this).data('id')}, function(){ sezonlariGetir(); });
                        }
                    });
                    $(document).on('click', '.cari-grup-sil', function(){
                        if(confirm('Cari grup silinsin mi?')){
                            $.post('illegal/cari-grup-sil', {cari_grup_id: $(this).data('id')}, function(){ cariGruplariGetir(); });
                        }
                    });
                    $(document).on('click', '.sektor-sil', function(){
                        if(confirm('Sektör silinsin mi?')){
                            $.post('illegal/sektor-sil', {sektor_id: $(this).data('id')}, function(){ sektorleriGetir(); });
                        }
                    });
                    ...
                    $(document).on('click', '.sezon-duzenle', function(){
                        ...
                        if(yeni && yeni !== eski){
                            $.post('illegal/sezon-guncelle', {sezon_id: id, sezon_adi: yeni}, function(){ sezonlariGetir(); });
                        }
                    });
                    $(document).on('click', '.cari-grup-duzenle', function(){
                        ...
                        if(yeni && yeni !== eski){
                            $.post('illegal/cari-grup-guncelle', {cari_grup_id: id, cari_grup: yeni}, function(){ cariGruplariGetir(); });
                        }
                    });
                    $(document).on('click', '.sektor-duzenle', function(){
                        ...
                        if(yeni && yeni !== eski){
                            $.post('illegal/sektor-guncelle', {sektor_id: id, sektor_adi: yeni}, function(){ sektorleriGetir(); });
                        }
                    });
