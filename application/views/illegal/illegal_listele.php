        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-sm-10">
                            <h3 class="page-title">İllegal Listesi</h3>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?= base_url(); ?>">Anasayfa</a></li>
                                <li class="breadcrumb-item">İllegal</li>
                                <li class="breadcrumb-item active">İllegal Listesi</li>
                            </ul>
                        </div>
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <h5 class="text-muted">İllegal kayıtlarını görüntüleyebilir ve yeni kayıt ekleyebilirsiniz.</h5>
                        </div>
                    </div>
                </div>
                <!-- /Sayfa Başlıkları -->
                ...
                <div class="card card-table">
                    <div class="card-body">
                        <div class="mb-3">
                            <button class="btn btn-primary" data-toggle="modal" data-target="#potansiyelSatisEkleModal">Yeni İllegal Ekle</button>
                        </div>
                    ...
                    <div class="modal-content">
                      <form method="post" action="<?= base_url('illegal/potansiyel_satis_ekle') ?>">
                        <div class="modal-header">
                          <h5 class="modal-title" id="potansiyelSatisEkleModalLabel">Yeni İllegal Ekle</h5>
