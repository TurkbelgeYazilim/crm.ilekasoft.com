...
<div class="page-header">
	<div class="row">
		<div class="col-sm-10">
			<h3 class="page-title">Senet Detayı</h3>
			<ul class="breadcrumb">
				<li class="breadcrumb-item"><a href="<?= base_url(); ?>">Anasayfa</a></li>
				<li class="breadcrumb-item"><a href="<?= base_url('muhasebe/senet-yonetim'); ?>">Senet Yönetimi</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="konum-degistir-form">
                ...
                <form method="post" action="<?= base_url('senet/konum_degistir') ?>">
                                ...
                                <div class="timeline-item <?= $is_current ? 'current' : '' ?>" 
                                    ...
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="flex-grow-1">
                                            ...
                                            <?php if($hareket->sh_aciklama): ?>
                                                <p class="mb-2 text-muted"><?= $hareket->sh_aciklama ?></p>
                                            <?php endif; ?>
