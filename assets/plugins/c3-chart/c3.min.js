...
!function (t, e) {
	...
	function n(t) {
		this.internal = new l(this), this.internal.loadConfig(t), this.internal.beforeInit(t), this.internal.init(), this.internal.afterInit(t), function e(i, n, r) {
	...
	function m(t) {
		var e = d(t), i = [t.pathSegList.getItem(0), t.pathSegList.getItem(1)];
	...
	e.prototype.axisX = function (t, e, i) {
		...
		return t.select("text").text(function (t) {
			...
			var e = d(this), i = a.textFormatted(t), n = e.height, r = i ? e.width / i.length : void 0;
			n && r && (o.h = n, o.w = r)
		...
		var n = this, r = n.params.tickMultiline ? n.splitTickText(t, i) : [].concat(n.textFormatted(t));
		...
		return (!c || c <= 0) && (c = s.isVertical() ? 95 : s.params.isCategory ? Math.ceil(e(1) - e(0)) - 12 : 110), function t(e, i) {
			a = void 0;
			for (var n = 1; n < i.length; n++) if (" " === i.charAt(n) && (a = n), r = i.substr(0, n + 1), o = s.tickTextCharSize.w * r.length, c < o) return t(e.concat(i.substr(0, a || n)), i.slice(a ? a + 1 : n));
			return e.concat(i)
		}([], i + "")
		...
		var w = this, v = w.d3, b = w.params;

		function T(t, m) {
			var S;
			return t.each(function () {
				var t, e, i, n = T.g = v.select(this), r = this.__chart__ || w.scale,
					a = this.__chart__ = w.copyScale(), o = w.tickValues ? w.tickValues : w.generateTicks(a),
					s = n.selectAll(".tick").data(o, a),
					c = s.enter().insert("g", ".domain").attr("class", "tick").style("opacity", 1e-6),
					d = s.exit().remove(), l = s.merge(c);
				...
				var u = l.select("line").merge(c.append("line")), h = l.select("text").merge(c.append("text")),
	...
	t.prototype.init = function () {
		...
		var s = this.owner, c = s.config, d = c["axis_" + t + "_tick_format"];
		...
		var i = this.getLabelOptionByAxisId(t), n = i && "object" == typeof i && i.position ? i.position : e;
		return {
		...
		var e = this.owner, i = e.main.select("." + Y.axisX + " ." + Y.axisXLabel),
	...
	var i = {
		version: "0.7.20",
		chart: {fn: n.prototype, internal: {fn: l.prototype, axis: {fn: p.prototype, internal: {fn: e.prototype}}}},
		generate: function (t) {
			return new n(t)
		}
	};
	...
	function f(t, e, i) {
		...
		return e || (e = t.scaleLinear()).range(n), i || ((i = t.scaleLog()).domain(n), i.nice()), r.domain = function (t) {
			...
			return function (t, e, i) {
				var n, r, a, o;
				if (arguments.length < 3) i = 10; else if (0 === i) return [];
	...
	l.prototype.beforeInit = function () {
		...
		"grid" === e && t.each(function () {
			var t = a.d3.select(this), e = t.attr("x1"), i = t.attr("x2"), n = t.attr("y1"), r = t.attr("y2");
		...
		var t = this, e = t.config, i = t.legend ? t.getLegendHeight() : 0, n = t.legend ? t.getLegendWidth() : 0,
			r = t.isLegendRight || t.isLegendInset ? 0 : i, a = t.hasArcType(),
		...
		} : {top: t.currentHeight - c - r, right: NaN, bottom: s + r, left: t.margin.left}, t.margin3 = {
			top: 0,
			right: NaN,
			bottom: 0,
			left: 0
		...
		var i, n, r, a, o, s, c, d, l, u, h, g, p, f, _, x = this, y = x.main, m = x.d3, S = x.config,
			w = x.getShapeIndices(x.isAreaType), v = x.getShapeIndices(x.isBarType),
			b = x.getShapeIndices(x.isLineType), T = x.hasArcType(), A = x.filterTargetsToShow(x.data.targets),
			P = x.xv.bind(x), C = B(t = t || {}, "withY", !0), L = B(t, "withSubchart", !0),
			V = B(t, "withTransition", !0), G = B(t, "withTransform", !1), E = B(t, "withUpdateXDomain", !1),
			O = B(t, "withUpdateOrgXDomain", !1), I = B(t, "withTrimXDomain", !0), R = B(t, "withUpdateXAxis", E),
			k = B(t, "withLegend", !1), F = B(t, "withEventRect", !0), D = B(t, "withDimension", !0),
			X = B(t, "withTransitionForExit", V), M = B(t, "withTransitionForAxis", V),
			z = V ? S.transition_duration : 0, H = X ? z : 0, N = M ? z : 0;
		if (e = e || x.axis.generateTransitions(N), k && S.legend_show ? x.updateLegend(x.mapToIds(x.data.targets), t, e) : D && x.updateDimension(!0), x.isCategorized() && 0 === A.length && x.x.domain([0, x.axes.x.selectAll(".tick").size()]), A.length ? (x.updateXDomain(A, E, O, I), S.axis_x_tick_values || (u = x.axis.updateXAxisTickValues(A))) : (x.xAxis.tickValues([]), x.subXAxis.tickValues([])), S.zoom_rescale && !t.flow && (p = x.x.orgDomain()), x.y.domain(x.getYDomain(A, "y", p)), x.y2.domain(x.getYDomain(A, "y2", p)), !S.axis_y_tick_values && S.axis_y_tick_count && x.yAxis.tickValues(x.axis.generateTickValues(x.y.domain(), S.axis_y_tick_count)), !S.axis_y2_tick_values && S.axis_y2_tick_count && x.y2Axis.tickValues(x.axis.generateTickValues(x.y2.domain(), S.axis_y2_tick_count)), x.axis.redraw(N, T), x.axis.updateLabels(V), (E || R) && A.length) if (S.axis_x_tick_culling && u) {
			for (h = 1; h < u.length; h++) if (u.length / h < S.axis_x_tick_culling_max) {
				g = h;
				break
			}
		...
		var i = t.axis && "y2" === t.axis ? this.y2 : this.y, n = e ? t[e] : t.value;
		...
		var t = this, e = t.svg.select("." + Y.brush + " .overlay");
		...
		return t.add = function (t) {
			...
			for (var e = 0; e < i.length; e++) if (i[e] === t) {
				i.splice(e, 1);
				break
			}
		}, t
		...
		i.prototype._isCurrentSpace = function () {
			...
			var t = 0, e = 0, i = 1, n = 0, r = 1, a = 1, o = this._currentIndex;
			if (this._skipOptionalSpaces(), this._currentIndex < this._endIndex && "+" == this._string.charAt(this._currentIndex) ? this._currentIndex++ : this._currentIndex < this._endIndex && "-" == this._string.charAt(this._currentIndex) && (this._currentIndex++, r = -1), !(this._currentIndex == this._endIndex || (this._string.charAt(this._currentIndex) < "0" || "9" < this._string.charAt(this._currentIndex)) && "." != this._string.charAt(this._currentIndex))) {
				...
				if (this._currentIndex != s) for (var c = this._currentIndex - 1, d = 1; s <= c;) e += d * (this._string.charAt(c--) - "0"), d *= 10;
			...
			var t = this._string[this._currentIndex], e = this._pathSegTypeFromChar(t);
		...
		value: function (t, e) {
			...
			for (var i = Object(t), n = 1; n < arguments.length; n++) {
				var r = arguments[n];
				if (null != r) for (var a in r) Object.prototype.hasOwnProperty.call(r, a) && (i[a] = r[a])
			}
			return i
		...
		r = c.convertDataToTargets(e, !0), c.data.targets.forEach(function (t) {
			for (var e, i = !1, n = 0; n < r.length; n++) if (t.id === r[n].id) {
			...
			for (var e, i = 0; i < d.length; i++) if (t.id === d[i]) for (h = t.values[t.values.length - 1].index + 1, e = 0; e < u; e++) t.values.push({
				id: t.id,
				index: h + e,
			...
			flow: {
				...
				orgDataCount: l
			}, withLegend: !0, withTransition: 1 < l, withTrimXDomain: !1, withUpdateXAxis: !0
		})
	}, l.prototype.generateFlow = function (G) {
		var E = this, O = E.config, I = E.d3;
		return function () {
			var t, e, n, r, a, o, s, c, d, l, i = G.targets, u = G.flow, h = G.drawBar, g = G.drawLine, p = G.drawArea,
				f = G.cx, _ = G.cy, x = G.xv, y = G.xForText, m = G.yForText, S = G.duration, w = u.index, v = u.length,
				b = E.getValueOnIndex(E.data.targets[0].values, w),
				T = E.getValueOnIndex(E.data.targets[0].values, w + v), A = E.x.domain(), P = u.duration || S,
				C = u.done || function () {
				}, L = E.generateWait();
		...
		var t = this.internal, i = t.config;
		...
		var e = this.internal, i = e.config, n = B(t = t || {}, "duration", i.transition_duration),
			r = B(t, "classes", [Y.region]), a = e.main.select("." + Y.regions).selectAll(r.map(function (t) {
				return "." + t
			}));
		...
		var u = this.internal, h = u.d3, g = u.config;
		g.data_selection_enabled && u.main.selectAll("." + Y.shapes).selectAll("." + Y.shape).each(function (t, e) {
			var i = h.select(this), n = t.data ? t.data.id : t.id, r = u.getToggle(this, t).bind(u),
				a = g.data_selection_grouped || !c || 0 <= c.indexOf(n), o = !d || 0 <= d.indexOf(e),
		...
		var l = this.internal, u = l.d3, h = l.config;
		h.data_selection_enabled && l.main.selectAll("." + Y.shapes).selectAll("." + Y.shape).each(function (t, e) {
			var i = u.select(this), n = t.data ? t.data.id : t.id, r = l.getToggle(this, t).bind(l),
				a = h.data_selection_grouped || !c || 0 <= c.indexOf(n), o = !d || 0 <= d.indexOf(e),
				s = i.classed(Y.SELECTED);
		...
		var i = this.internal, n = 0 <= ["pie", "donut"].indexOf(t) ? {withTransform: !0} : null;
		i.transformTo(e, t, n)
	}, l.prototype.transformTo = function (t, e, i) {
		var n = this, r = !n.hasArcType(), a = i || {withTransitionForAxis: r};
		...
		var n = this, e = n.hasType("gauge"), i = n.gaugeArcWidth / n.filterTargetsToShow(n.data.targets).length,
		...
		e = e || 1;
		var i = this, n = i.hasType("gauge"), r = i.gaugeArcWidth / i.filterTargetsToShow(i.data.targets).length,
		...
		var e = this, i = e.main, n = e.classChartArc.bind(e), r = e.classArcs.bind(e), a = e.classFocus.bind(e),
		...
		var n, r, a, o, l = this, u = l.d3, s = l.config, c = l.main, d = l.hasType("gauge"),
		...
		var e = this.config.data_classes[t], i = e ? " " + Y.target + "-" + e : "";
		...
		var t = this.config, e = this.d3, n = t.data_colors,
			r = L(t.color_pattern) ? t.color_pattern : e.schemeCategory10, a = t.data_color, o = [];
		return function (t) {
		...
		var t = this.config, n = t.color_pattern, e = t.color_threshold, r = "value" === e.unit,
			a = e.values && e.values.length ? e.values : [], o = e.max || 100;
		return L(e) && L(n) ? function (t) {
			for (var e = n[n.length - 1], i = 0; i < a.length; i++) if ((r ? t : 100 * t / o) < a[i]) {
				e = n[i];
				break
			}
			return e
		...
		return i.forEach(function (i) {
			...
			return {
				id: c, id_org: o, values: t.map(function (t, e) {
		...
		var e = this, t = e.getFromCache("getTotalDataSum");
		...
		for (var i = this.mapToIds(t), n = 0; n < i.length; n++) if (i[n] === e) return !0;
		return !1
		...
		for (var i, n, r = Object.keys(t), a = 0; a < r.length; a++) for (n = t[r[a]].values, i = 0; i < n.length; i++) if (e(n[i].value)) return !0;
		return !1
		...
		var t = this.config, r = this.isOrderAsc(), e = this.isOrderDesc();
		if (r || e) {
			var a = function (t, e) {
				return t + Math.abs(e.value)
			};
			return function (t, e) {
				var i = t.values.reduce(a, 0), n = e.values.reduce(a, 0);
				return r ? n - i : i - n
			}
		}
		...
		var i = this.config, n = i.axis_rotated ? 1 : 0, r = i.axis_rotated ? 0 : 1, a = this.circleY(t, t.index),
			o = this.x(t.x);
		return Math.sqrt(Math.pow(o - e[n], 2) + Math.pow(a - e[r], 2))
	},l.prototype.horizontalDistance = function (t, e) {
		var i = this.config.axis_rotated ? 1 : 0, n = this.x(t.x);
		...
		i && (n.filter && (i = i.filter(n.filter)), (n.type || n.types) && i.forEach(function (t) {
			...
			for (var e = 0; e < i.length; e++) if (t.id === i[e].id) {
		...
		if (0 < c.data_groups.length) for (o = s.hasNegativeValueInTargets(t), e = 0; e < c.data_groups.length; e++) if (0 !== (r = c.data_groups[e].filter(function (t) {
			return 0 <= d.indexOf(t)
		})).length) for (n = r[0], o && l[n] && l[n].forEach(function (t, e) {
			l[n][e] = t < 0 ? t : 0
		...
		var e, i, n, r, a, o, s = this, c = s.config, d = s.mapToIds(t), l = s.getValuesAsIdKeyed(t);
		if (0 < c.data_groups.length) for (o = s.hasPositiveValueInTargets(t), e = 0; e < c.data_groups.length; e++) if (0 !== (r = c.data_groups[e].filter(function (t) {
			return 0 <= d.indexOf(t)
		})).length) for (n = r[0], o && l[n] && l[n].forEach(function (t, e) {
			l[n][e] = 0 < t ? t : 0
		}), i = 1; i < r.length; i++) a = r[i], l[a] && l[a].forEach(function (t, e) {
		...
		var a, o, s, c, d, l, u, h, g, p, f, _ = t.filter(function (t) {
			...
			}), x = i ? n.filterByXDomain(_, i) : _, y = "y2" === e ? r.axis_y2_min : r.axis_y_min,
			m = "y2" === e ? r.axis_y2_max : r.axis_y_max, S = n.getYDomainMin(x), w = n.getYDomainMax(x),
			v = "y2" === e ? r.axis_y2_center : r.axis_y_center,
			b = n.hasType("bar", x) && r.bar_zerobased || n.hasType("area", x) && r.area_zerobased,
			T = "y2" === e ? r.axis_y2_inverted : r.axis_y_inverted, A = n.hasDataLabel() && r.axis_rotated,
			P = n.hasDataLabel() && !r.axis_rotated, S = C(y) ? y : !C(m) || S < m ? S : m - 10,
		...
		var e, i, n, r = this.config, a = t[1] - t[0],
		...
		var e = this, i = [e.getXDomainMin(t), e.getXDomainMax(t)], n = i[0], r = i[1], a = e.getXDomainPadding(i),
			o = 0, s = 0;
		...
		_.hasArcType() || x.data_selection_enabled && x.data_selection_multiple && (e = _.dragStart[0], i = _.dragStart[1], n = t[0], r = t[1], h = Math.min(e, n), g = Math.max(e, n), p = x.data_selection_grouped ? _.margin.top : Math.min(i, r), f = x.data_selection_grouped ? _.height : Math.max(i, r), a.select("." + Y.dragarea).attr("x", h).attr("y", p).attr("width", g - h).attr("height", f - p), a.selectAll("." + Y.shapes).selectAll("." + Y.shape).each(function (t, e) {
			if (x.data_selection_isselectable(t)) {
				...
				if (c.classed(Y.circle)) i = +c.attr("cx"), n = +c.attr("cy"), o = _.togglePoint, u = h < i && i < g && p < n && n < f; else {
		...
		var n = this, r = t && !n.hasType("gauge") ? n.defaultArcValueFormat : n.yFormat,
		...
		var e = this, i = e.config, n = e.d3, r = e.generateGridData(i.grid_x_type, e.x),
		...
		var e, i, n, r, a = this, o = a.main, s = a.config, c = a.xv.bind(a), d = a.yv.bind(a),
			l = a.xGridTextX.bind(a), u = a.yGridTextX.bind(a);
		...
		var i = this, n = i.config, r = i.xv.bind(i), a = i.xgridLines.select("line"), o = i.xgridLines.select("text");
		...
		var e = this, i = e.config, n = t.filter(function (t) {
			return t && C(t.value)
		}), r = e.main.selectAll("line." + Y.xgridFocus), a = e.xx.bind(e);
		...
		if ("year" === t) for (n = (i = this.getXDomain())[0].getFullYear(), r = i[1].getFullYear(), a = n; a <= r; a++) o.push(new Date(a + "-01-01 00:00:00")); else (o = e.ticks(10)).length > s && (o = o.filter(function (t) {
			return ("" + t).indexOf(".") < 0
		}));
		return o
		...
		var n = this.config, r = this.getGridFilterToRemove(t), a = e ? Y.xgridLines : Y.ygridLines,
		...
		var i = "." + Y.eventRect, n = this.main.select(i).node(), r = n.getBoundingClientRect(),
			a = r.left + (e ? e[0] : 0), o = r.top + (e ? e[1] : 0), s = document.createEvent("MouseEvents");
		...
		var i, n, r, a, o, s, c, d, l, u, h, g, p, _, x, y, m = this, S = m.config, w = 4, v = 10, b = 0, T = 0, A = 10,
			P = S.legend_item_tile_width + 5, C = 0, L = {}, V = {}, G = {}, E = [0], O = {}, I = 0;

		function R(t, e, i) {
			var n, r, a, o, s = 0 === i, c = i === f.length - 1,
				...
				u = d.height + w, h = m.isLegendRight || m.isLegendInset ? u : l,
		...
		var n = e.main.select("." + Y.regions).selectAll("." + Y.region).data(i.regions), r = n.enter().append("g");
		...
		var i = this, n = i.mainRegion, r = i.mainRegion.selectAll("text");
		...
		var e = this, i = e.config, n = e.regionX(t), r = "y" === t.axis ? e.y : e.y2,
		...
		var e = this, i = e.config, n = this.regionY(t), r = "y" === t.axis ? e.y : e.y2,
		...
		var e = "paddingX" in t ? t.paddingX : 3, i = "paddingY" in t ? t.paddingY : 3;
		...
		var r, a = this.getScale(t, e, this.isTimeSeries()), o = i ? a.domain(i) : a,
		...
		var n;
		if ("timeseries" === t || "time" === t) n = this.d3.scaleTime(); else if ("log" === t) n = f(this.d3); else {
		...
		var n = this, r = n.config, a = (r.axis_rotated ? n.circleY : n.circleX).bind(n),
			o = (r.axis_rotated ? n.circleX : n.circleY).bind(n), s = n.pointSelectR.bind(n);
		...
		var n = this, r = n.d3, a = n.config, o = r.select(t), s = o.classed(Y.SELECTED), c = n.getToggle(t, e).bind(n);
		...
		var e = this, i = e.config, n = e.classChartBar.bind(e), r = e.classBars.bind(e), a = e.classFocus.bind(e);
		...
		var i = this, n = i.barData.bind(i), r = i.classBar.bind(i), a = i.initialOpacity.bind(i),
		...
		var a = this.config, o = this.generateGetBarPoints(t, e);
		return function (t, e) {
			var i = o(t, e), n = a.axis_rotated ? 1 : 0, r = a.axis_rotated ? 0 : 1;
			return "M " + i[0][n] + "," + i[0][r] + " L" + i[1][n] + "," + i[1][r] + " L" + i[2][n] + "," + i[2][r] + " L" + i[3][n] + "," + i[3][r] + " z"
		}
	},l.prototype.generateGetBarPoints = function (t, e) {
		var o = this, i = e ? o.subXAxis : o.xAxis, n = t.__max__ + 1, s = o.getBarW(i, n),
			c = o.getShapeX(s, n, t, !!e), d = o.getShapeY(!!e), l = o.getShapeOffset(o.isBarType, t, !!e),
			u = s * (o.config.bar_space / 2), h = e ? o.getSubYScale : o.getYScale;
		return function (t, e) {
			var i = h.call(o, t.id)(0), n = l(t, e) || i, r = c(t), a = d(t);
			return o.config.axis_rotated && (0 < t.value && a < i || t.value < 0 && i < a) && (a = i), [[r + u, n], [r + u, a -= i - n], [r + s - u, a], [r + s - u, n]]
		}
	},l.prototype.isWithinBar = function (t, e) {
		return function (t, e, i) {
			void 0 === i && (i = 0);
			var n = e.x - i, r = e.x + e.width + i, a = e.y + e.height + i, o = e.y - i;
		...
		return this.filterTargetsToShow(this.data.targets.filter(t, this)).forEach(function (t) {
			for (e = 0; e < n.data_groups.length; e++) if (!(n.data_groups[e].indexOf(t.id) < 0)) for (i = 0; i < n.data_groups[e].length; i++) if (n.data_groups[e][i] in r) {
		...
		var l = this, i = l.orderTargets(l.filterTargetsToShow(l.data.targets.filter(t, l))), u = i.map(function (t) {
			return t.id
		});
		return function (r, a) {
			var o = e ? l.getSubYScale(r.id) : l.getYScale(r.id), s = o(0), c = s;
			return i.forEach(function (t) {
				var e = l.isStepType(r) ? l.convertValuesToStep(t.values) : t.values, i = l.isTargetNormalized(r.id),
					n = e.map(function (t) {
		...
		var i = this, e = i.config, n = i.classChartLine.bind(i), r = i.classLines.bind(i), a = i.classAreas.bind(i),
			o = i.classCircles.bind(i), s = i.classFocus.bind(i),
		...
		var e = this, i = e.main.selectAll("." + Y.lines).selectAll("." + Y.line).data(e.lineData.bind(e)),
		...
		var c = this, d = c.config, l = c.d3.line(), n = c.generateGetLinePoints(t, s),
			u = s ? c.getSubYScale : c.getYScale, l = d.axis_rotated ? l.x(i).y(e) : l.x(e).y(i);
		return d.line_connectNull || (l = l.defined(function (t) {
			return null != t.value
		})), function (t) {
			var e = d.line_connectNull ? c.filterRemoveNull(t.values) : t.values, i = s ? c.subX : c.x,
				n = u.call(c, t.id), r = 0, a = 0,
		...
		var o = this, s = o.config, i = t.__max__ + 1, c = o.getShapeX(0, i, t, !!e), d = o.getShapeY(!!e),
			l = o.getShapeOffset(o.isLineType, t, !!e), u = e ? o.getSubYScale : o.getYScale;
		return function (t, e) {
			var i = u.call(o, t.id)(0), n = l(t, e) || i, r = c(t), a = d(t);
			return s.axis_rotated && (0 < t.value && a < i || t.value < 0 && i < a) && (a = i), [[r, a - (i - n)], [r, a - (i - n)], [r, a - (i - n)], [r, a - (i - n)]]
		}
	},l.prototype.lineWithRegions = function (t, d, l, e) {
		var i, n, r, a, u, o, s, c, h, g, p, f = this, _ = f.config, x = "M", y = f.isCategorized() ? .5 : 0, m = [];
		if (k(e)) for (i = 0; i < e.length; i++) m[i] = {}, w(e[i].start) ? m[i].start = t[0].x : m[i].start = f.isTimeSeries() ? f.parseDate(e[i].start) : e[i].start, w(e[i].end) ? m[i].end = t[t.length - 1].x : m[i].end = f.isTimeSeries() ? f.parseDate(e[i].end) : e[i].end;
		...
		for (g = _.axis_rotated ? function (t) {
			...
			var r = t.x.getTime(), a = e.x - t.x, o = new Date(r + a * i), s = new Date(r + a * (i + n)),
			...
			if (w(m) || !function (t, e) {
				for (var i = 0; i < e.length; i++) if (e[i].start < t && t <= e[i].end) return 1
			}(t[i].x, m)) x += " " + g(t[i]) + " " + p(t[i]); else for (a = f.getScale(t[i - 1].x + y, t[i].x + y, f.isTimeSeries()), u = f.getScale(t[i - 1].value, t[i].value), o = d(t[i].x) - d(t[i - 1].x), s = l(t[i].value) - l(t[i - 1].value), h = 2 * (c = 2 / Math.sqrt(Math.pow(o, 2) + Math.pow(s, 2))), n = c; n <= 1; n += h) x += r(t[i - 1], t[i], n, c);
			t[i].x
		}
		return x
	},l.prototype.updateArea = function (t) {
		var e = this, i = e.d3, n = e.main.selectAll("." + Y.areas).selectAll("." + Y.area).data(e.lineData.bind(e)),
		...
		var a = this, o = a.config, s = a.d3.area(), c = a.generateGetAreaPoints(t, e),
		...
		return o.line_connectNull || (s = s.defined(function (t) {
			...
			var e = o.line_connectNull ? a.filterRemoveNull(t.values) : t.values, i = 0, n = 0,
		...
		var o = this, s = o.config, i = t.__max__ + 1, c = o.getShapeX(0, i, t, !!e), d = o.getShapeY(!!e),
			l = o.getShapeOffset(o.isAreaType, t, !!e), u = e ? o.getSubYScale : o.getYScale;
		return function (t, e) {
			var i = u.call(o, t.id)(0), n = l(t, e) || i, r = c(t), a = d(t);
			return s.axis_rotated && (0 < t.value && a < i || t.value < 0 && i < a) && (a = i), [[r, n], [r, a - (i - n)], [r, a - (i - n)], [r, n]]
		}
		...
		var r = this, a = r.main.selectAll("." + Y.selectedCircle);
		...
		var i = this.d3, n = i.mouse(t), r = i.select(t), a = +r.attr("cx"), o = +r.attr("cy");
		...
		var t = this.config, e = C(t.padding_top) ? t.padding_top : 0;
		...
		var t = this, e = t.config, i = 0, n = t.isLegendRight ? t.getLegendWidth() + 20 : 0,
		...
		var e = this, i = e.config, n = i.axis_rotated || !i.axis_rotated && !i.axis_y_inner,
			r = i.axis_rotated ? Y.axisX : Y.axisY, a = e.main.select("." + r).node(),
			o = a && n ? a.getBoundingClientRect() : {right: 0}, s = e.selectChart.node().getBoundingClientRect(),
			c = e.hasArcType(), d = o.right - s.left - (c ? 0 : e.getCurrentPaddingLeft(t));
		return 0 < d ? d : 0
		...
		var e, i, n = this, r = n.context, a = n.config, o = n.classChartBar.bind(n), s = n.classBars.bind(n),
			c = n.classChartLine.bind(n), d = n.classLines.bind(n), l = n.classAreas.bind(n),
		...
		var e = this, i = e.context.selectAll("." + Y.bars).selectAll("." + Y.bar).data(e.barData.bind(e)),
		...
		var e = this, i = e.context.selectAll("." + Y.lines).selectAll("." + Y.line).data(e.lineData.bind(e)),
			n = i.enter().append("path").attr("class", e.classLine.bind(e)).style("stroke", e.color);
		...
		var e = this, i = e.d3, n = e.context.selectAll("." + Y.areas).selectAll("." + Y.area).data(e.lineData.bind(e)),
			r = n.enter().append("path").attr("class", e.classArea.bind(e)).style("fill", e.color).style("opacity", function () {
				return e.orgAreaOpacity = +i.select(this).style("opacity"), 0
			});
		...
		var e = this, i = e.classChartText.bind(e), n = e.classTexts.bind(e), r = e.classFocus.bind(e),
		...
		var n = this, r = n.config, a = n.barOrLineData.bind(n), o = n.classText.bind(n),
		...
		var r = this, a = r.generateGetAreaPoints(t, !1), o = r.generateGetBarPoints(e, !1),
			s = r.generateGetLinePoints(i, !1), c = n ? r.getXForText : r.getYForText;
		return function (t, e) {
		...
		var t, e, i, n, r, a, o = this, s = o.d3, c = o.config, d = o.data.targets[0],
		...
		var e = this.axis.getLabelText("x"), i = this.axis.getLabelText("y");
		...
		var t = this.data.targets[0], e = t.values.reduce(function (t, e) {
			return t + Number(e.epochs)
		}, 0), n = t.values.reduce(function (t, e) {
	...
	return l.prototype.initStanfordElements = function () {
		...
		var e, i, n, r, a = this, o = a.main, s = a.config, c = a.xvCustom.bind(a), d = a.yvCustom.bind(a),
		...
		var r, a, o, s, c, d, l = this, u = l.config, h = u.tooltip_format_title || e,
		...
		for (f && t.sort(f), a = 0; a < t.length; a++) if (t[a] && (t[a].value || 0 === t[a].value)) {
			if (l.isStanfordGraphType()) r || (o = l.getStanfordTooltipTitle(t[a]), r = "<table class='" + l.CLASS.tooltip + "'>" + o), d = l.getStanfordPointColor(t[a]), c = _(u.data_epochs), s = t[a].epochs; else if (r || (o = _(h ? h(t[a].x, t[a].index) : t[a].x), r = "<table class='" + l.CLASS.tooltip + "'>" + (o || 0 === o ? "<tr><th colspan='2'>" + o + "</th></tr>" : "")), void 0 !== (s = _(p(t[a].value, t[a].ratio, t[a].id, t[a].index, t)))) {
		...
		var e, t, i = this, n = i.d3, r = i.config, a = i.context = i.svg, o = i.margin.left + 20.5,
			s = i.margin.top + .5;
		...
		var t = this, e = t.d3, i = t.config, n = t.zoom, r = t.x;
